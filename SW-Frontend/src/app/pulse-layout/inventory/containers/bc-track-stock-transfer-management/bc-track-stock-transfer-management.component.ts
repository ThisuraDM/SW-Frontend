...
@Component({
    selector: 'SW-track-stock-transfer-bc-to-bc-management',
    templateUrl: './bc-track-stock-transfer-management.component.html'
})
export class BcTrackStockTransferManagement implements OnInit {
    ...
    onStartAcknowledgeClick(row:StockTransferItemDetails): void {
        this.itemRow = row;
        this.displayScreen = NavigationOptions.START_ACKNOWLEDGE_NEW;
    }
    ...
    public setHeadingBarInputData(): { title: string, screenToNavigate: NavigationOptions } {
        ...
        switch (this.displayScreen) {
            ...
            case NavigationOptions.ACKNOWLEDGE_TRANSFER_STOCK_SUMMARY:
                headingInputData = {title: 'Acknowledge Transfer Summary', screenToNavigate: NavigationOptions.START_ACKNOWLEDGE};
                break;
        }
